...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "SwiperCore", function() { return /* reexport */ core_class; });
__webpack_require__.d(__webpack_exports__, "Swiper", function() { return /* reexport */ swiper_Swiper; });
__webpack_require__.d(__webpack_exports__, "SwiperSlide", function() { return /* reexport */ SwiperSlide; });
    ...
    for (var i = 0; i < this.length; i += 1) {
      if (typeof newChild === 'string') {
        ...
        while (tempDiv.firstChild) {
          document.appendChild(tempDiv.firstChild);
        }
      } else if (newChild instanceof Dom7) {
        for (var j = 0; j < newChild.length; j += 1) {
          document.appendChild(newChild[j]);
        }
      } else {
...
function dom7_esm_children(selector) {
...
function src_utils_isObject(o) {
  return typeof o === 'object' && o !== null && o.constructor && Object.prototype.toString.call(o).slice(8, -1) === 'Object';
}

function src_utils_extend(target, src) {
  const noExtend = ['__proto__', 'constructor', 'prototype'];
  Object.keys(src).filter(key => noExtend.indexOf(key) < 0).forEach(key => {
    if (typeof target[key] === 'undefined') target[key] = src[key];else if (src_utils_isObject(src[key]) && src_utils_isObject(target[key]) && Object.keys(src[key]).length > 0) {
      if (src[key].__swiper__) target[key] = src[key];else src_utils_extend(target[key], src[key]);
    } else {
      target[key] = src[key];
    }
  });
...
// CONCATENATED MODULE: ./src/get-params.js
...
function getParams(obj = {}) {
  ...
  const passedParams = {};
  src_utils_extend(params, core_class.defaults);
  src_utils_extend(params, core_class.extendedDefaults);
  ...
  Object.keys(plainObj).forEach(key => {
    ...
    if (allowedParams.indexOf(key) >= 0) {
      if (src_utils_isObject(obj[key])) {
        params[key] = {};
        passedParams[key] = {};
        src_utils_extend(params[key], obj[key]);
        src_utils_extend(passedParams[key], obj[key]);
      } else {
        params[key] = obj[key];
...
// CONCATENATED MODULE: ./src/init-swiper.js
...
function calcLoopedSlides(slides, swiperParams) {
  ...
  if (swiperParams.breakpoints) {
    const breakpoint = core_class.prototype.getBreakpoint(swiperParams.breakpoints);
...
function renderLoop(h, swiperRef, slides, swiperParams) {
  ...
  function duplicateSlide(child, index, position) {
    if (!child.props) child.props = {};
    return h(child.componentOptions.tag, { ...child.props,
      key: `${child.key}-duplicate-${index}-${position}`,
      staticClass: `${child.data.staticClass || ''} ${swiperParams.slideDuplicateClass}`,
      class: child.data.class,
      attrs: {
        [child.context.$options._scopeId]: ''
      }
  ...
  if (swiperRef) {
    swiperRef.loopedSlides = loopedSlides;
  }
...
// CONCATENATED MODULE: ./src/get-changed-params.js
...
function getChangedParams(swiperParams, oldParams, children, oldChildren) {
  ...
  watchParams.forEach(key => {
    if (key in swiperParams && key in oldParams) {
      if (src_utils_isObject(swiperParams[key]) && src_utils_isObject(oldParams[key])) {
...
// CONCATENATED MODULE: ./src/update-swiper.js
...
function updateSwiper({
  ...
  updateParams.forEach(key => {
    if (src_utils_isObject(currentParams[key]) && src_utils_isObject(passedParams[key])) {
      src_utils_extend(currentParams[key], passedParams[key]);
    } else {
...
// CONCATENATED MODULE: ./src/virtual.js
...
function renderVirtual(h, swiperRef, slides, virtualData) {
...
// CONCATENATED MODULE: ./src/swiper-slide.js


const SwiperSlide = external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend({
  name: 'SwiperSlide',
  props: {
    tag: {
      type: String,
  ...
  computed: {
    slideElRef() {
      var _this$$refs, _this$$refs$slide;

      return (_this$$refs = this.$refs) === null || _this$$refs === void 0 ? void 0 : (_this$$refs$slide = _this$$refs.slide) === null || _this$$refs$slide === void 0 ? void 0 : _this$$refs$slide.el;
    },

    slideData() {
      return {
        isActive: this.slideClasses.indexOf('swiper-slide-active') >= 0 || this.slideClasses.indexOf('swiper-slide-duplicate-active') >= 0,
        isVisible: this.slideClasses.indexOf('swiper-slide-visible') >= 0,
        isDuplicate: this.slideClasses.indexOf('swiper-slide-duplicate') >= 0,
        isPrev: this.slideClasses.indexOf('swiper-slide-prev') >= 0 || this.slideClasses.indexOf('swiper-slide-duplicate-prev') >= 0,
        isNext: this.slideClasses.indexOf('swiper-slide-next') >= 0 || this.slideClasses.indexOf('swiper-slide-duplicate-next') >= 0
      };
    }
  ...
  render(h) {
    ...
    }, scopedSlots.default && scopedSlots.default(self.slideData)) : scopedSlots.default && scopedSlots.default(self.slideData));
  }
...
const swiper_Swiper = external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend({
  name: 'Swiper',
  components: {
  ...
  created() {
    ...
    if (this.swiperRef.virtual && this.swiperRef.params.virtual.enabled) {
      ...
      src_utils_extend(this.swiperRef.params.virtual, extendWith);
      src_utils_extend(this.swiperRef.originalParams.virtual, extendWith);
    }
  },
  ...
  updated() {
    const props = this.$props; // set initialized flag
    ...
    const changedParams = getChangedParams(newPassedParams, this.oldPassedParamsRef, this.slidesRef.value, this.oldSlidesRef.value);
  ...
  render(h) {
    ...
    const slidesRefLoc = {
      value: [...this.slidesRef.value]
    };
    const oldSlidesRefLoc = {
      value: [...this.oldSlidesRef.value]
    };
    const {
      slides,
      slots
    } = getChildren(scopedSlots, slidesRefLoc, oldSlidesRefLoc); // bypass swiper instance to slides
    ...
    function renderSlides(slides) {
      ...
      if (!swiperParams.loop || (_self$swiperRef = self.swiperRef) !== null && _self$swiperRef !== void 0 && _self$swiperRef.destroyed) {
...
/******/ });
//# sourceMappingURL=swiper-vue2.common.js.map
