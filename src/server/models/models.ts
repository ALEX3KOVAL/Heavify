import {INTEGER, Model, ModelStatic, STRING, FLOAT} from "sequelize";
...
const UserSong: ModelStatic<Model> = sequelize.define('user_songs', {
    id: {type: INTEGER, primaryKey: true, autoIncrement: true},
    //@ts-ignore
...
const AlbumSong: ModelStatic<Model> = sequelize.define('album_songs', {
    id: {type: INTEGER, primaryKey: true, autoIncrement: true},
    //@ts-ignore
...
const GenreSong: ModelStatic<Model> = sequelize.define('genre_songs', {
    id: {type: INTEGER, primaryKey: true, autoIncrement: true},
    //@ts-ignore
...
const GenreAlbum: ModelStatic<Model> = sequelize.define('genre_albums', {
    id: {type: INTEGER, primaryKey: true, autoIncrement: true},
    //@ts-ignore
    genreId: {type: INTEGER, foreignKey: true, references: {table: "genres", field: "id", onDelete: "cascade", onUpdate: "cascade"}},
    //@ts-ignore
...
const AuthorAlbum: ModelStatic<Model> = sequelize.define('author_albums', {
    id: {type: INTEGER, primaryKey: true, autoIncrement: true},
    //@ts-ignore
...
const SelectionSong: ModelStatic<Model> = sequelize.define('selection_songs', {
    id: {type: INTEGER, primaryKey: true, autoIncrement: true},
    //@ts-ignore
...
const AuthorSong: ModelStatic<Model> = sequelize.define('author_songs', {
    id: {type: INTEGER, primaryKey: true, autoIncrement: true},
    //@ts-ignore
    authorId: {type: INTEGER, foreignKey: true, references: {table: "authors", field: "id", onDelete: "cascade", onUpdate: "cascade"}},
    //@ts-ignore
