...
export const getAttributesConstantsBy = (modelName, queryKey = "") => {
    switch (modelName) {
        case "song":
            switch (queryKey) {
                case "":
...
export const createWhereClauseObject = (model, id, queryValue, queryKey = "") => {
    switch (queryKey) {
        case "":
            return {};
        default:
...
//# sourceMappingURL=databaseQueryUtils.js.map