...
import seq from "../../../db";
const getAllSongsInfoBy = async (queryValue = "", queryKey = "") => {
    switch (queryKey) {
        case "":
            let allSongsInfo = await findAll(Song, getAttributesConstantsBy("song"), true, true, getIncludeConstantsBy("song"));
        ...
        case "search":
            ...
            return result;
        default:
            let allSongsInfoQueryKey = await findAll(Song, getAttributesConstantsBy("song", queryKey), true, true, getIncludeConstantsBy("song", queryKey), createWhereClauseObject("song", "songId", queryValue, queryKey));
