...
const going = (isIntersecting: any) => isIntersecting ? GOING_IN : GOING_OUT
...
const direction = (boundingClientRect: any, oldBoundingClientRect: any) => {
...
const extractWaypointData = (node: any) => node._waypointData

const extractOldBoundingClientRect = (node: any, defaultBoundingClientRect: any) => {
